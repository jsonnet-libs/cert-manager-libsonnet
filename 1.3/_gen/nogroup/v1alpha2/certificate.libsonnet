{
  ...
  spec: {
    ...
    '#withDuration':: d.fn(help="\"The requested 'duration' (i.e. lifetime) of the Certificate. This option may be ignored/overridden by some issuer types. If overridden and `renewBefore` is greater than the actual certificate duration, the certificate will be automatically renewed 2/3rds of the way through the certificate's duration.\"", args=[d.arg(name='duration', type=d.T.string)]),
    withDuration(duration): { spec+: { duration: duration } },
    '#withEmailSANs':: d.fn(help='"EmailSANs is a list of email subjectAltNames to be set on the Certificate."', args=[d.arg(name='emailSANs', type=d.T.array)]),
    withEmailSANs(emailSANs): { spec+: { emailSANs: if std.isArray(v=emailSANs) then emailSANs else [emailSANs] } },
    '#withEmailSANsMixin':: d.fn(help='"EmailSANs is a list of email subjectAltNames to be set on the Certificate."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='emailSANs', type=d.T.array)]),
    withEmailSANsMixin(emailSANs): { spec+: { emailSANs+: if std.isArray(v=emailSANs) then emailSANs else [emailSANs] } },
    ...
    '#withKeyAlgorithm':: d.fn(help='"KeyAlgorithm is the private key algorithm of the corresponding private key for this certificate. If provided, allowed values are either `rsa` or `ecdsa` If `keyAlgorithm` is specified and `keySize` is not provided, key size of 256 will be used for `ecdsa` key algorithm and key size of 2048 will be used for `rsa` key algorithm."', args=[d.arg(name='keyAlgorithm', type=d.T.string)]),
    withKeyAlgorithm(keyAlgorithm): { spec+: { keyAlgorithm: keyAlgorithm } },
    '#withKeyEncoding':: d.fn(help="\"KeyEncoding is the private key cryptography standards (PKCS) for this certificate's private key to be encoded in. If provided, allowed values are `pkcs1` and `pkcs8` standing for PKCS#1 and PKCS#8, respectively. If KeyEncoding is not specified, then `pkcs1` will be used by default.\"", args=[d.arg(name='keyEncoding', type=d.T.string)]),
    withKeyEncoding(keyEncoding): { spec+: { keyEncoding: keyEncoding } },
    '#withKeySize':: d.fn(help='"KeySize is the key bit size of the corresponding private key for this certificate. If `keyAlgorithm` is set to `rsa`, valid values are `2048`, `4096` or `8192`, and will default to `2048` if not specified. If `keyAlgorithm` is set to `ecdsa`, valid values are `256`, `384` or `521`, and will default to `256` if not specified. No other values are allowed."', args=[d.arg(name='keySize', type=d.T.integer)]),
    withKeySize(keySize): { spec+: { keySize: keySize } },
    '#withOrganization':: d.fn(help='"Organization is a list of organizations to be used on the Certificate."', args=[d.arg(name='organization', type=d.T.array)]),
    withOrganization(organization): { spec+: { organization: if std.isArray(v=organization) then organization else [organization] } },
    '#withOrganizationMixin':: d.fn(help='"Organization is a list of organizations to be used on the Certificate."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='organization', type=d.T.array)]),
    withOrganizationMixin(organization): { spec+: { organization+: if std.isArray(v=organization) then organization else [organization] } },
    '#withRenewBefore':: d.fn(help="\"The amount of time before the currently issued certificate's `notAfter` time that cert-manager will begin to attempt to renew the certificate. If this value is greater than the total duration of the certificate (i.e. notAfter - notBefore), it will be automatically renewed 2/3rds of the way through the certificate's duration.\"", args=[d.arg(name='renewBefore', type=d.T.string)]),
    ...
    '#withUriSANs':: d.fn(help='"URISANs is a list of URI subjectAltNames to be set on the Certificate."', args=[d.arg(name='uriSANs', type=d.T.array)]),
    withUriSANs(uriSANs): { spec+: { uriSANs: if std.isArray(v=uriSANs) then uriSANs else [uriSANs] } },
    '#withUriSANsMixin':: d.fn(help='"URISANs is a list of URI subjectAltNames to be set on the Certificate."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='uriSANs', type=d.T.array)]),
