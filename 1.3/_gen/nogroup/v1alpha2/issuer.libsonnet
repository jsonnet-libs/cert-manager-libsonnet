  ...
  spec: {
    ...
    acme: {
      ...
      externalAccountBinding: {
        ...
        '#withKeyAlgorithm':: d.fn(help='"keyAlgorithm is the MAC key algorithm that the key is used for. Valid values are \\"HS256\\", \\"HS384\\" and \\"HS512\\"."', args=[d.arg(name='keyAlgorithm', type=d.T.string)]),
      ...
      solvers: {
        ...
        dns01: {
          ...
          azuredns: {
            ...
            '#withHostedZoneName':: d.fn(help='', args=[d.arg(name='hostedZoneName', type=d.T.string)]),
            withHostedZoneName(hostedZoneName): { dns01+: { azuredns+: { hostedZoneName: hostedZoneName } } },
            '#withResourceGroupName':: d.fn(help='', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
        ...
        http01: {
          ...
          ingress: {
            ...
            '#withServiceType':: d.fn(help='"Optional service type for Kubernetes solver service"', args=[d.arg(name='serviceType', type=d.T.string)]),
