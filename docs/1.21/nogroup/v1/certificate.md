---
permalink: /1.21/nogroup/v1/certificate/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withRenewBeforePercentage(renewBeforePercentage)`](#fn-specwithrenewbeforepercentage)
  ...
  * [`fn withSignatureAlgorithm(signatureAlgorithm)`](#fn-specwithsignaturealgorithm)
  ...
  * [`obj spec.keystores`](#obj-speckeystores)
    * [`obj spec.keystores.jks`](#obj-speckeystoresjks)
      ...
      * [`fn withPassword(password)`](#fn-speckeystoresjkswithpassword)
    ...
    * [`obj spec.keystores.pkcs12`](#obj-speckeystorespkcs12)
      ...
      * [`fn withPassword(password)`](#fn-speckeystorespkcs12withpassword)
  ...
  * [`obj spec.renewal`](#obj-specrenewal)
    * [`fn withPolicy(policy)`](#fn-specrenewalwithpolicy)
    * [`fn withWindows(windows)`](#fn-specrenewalwithwindows)
    * [`fn withWindowsMixin(windows)`](#fn-specrenewalwithwindowsmixin)
    * [`obj spec.renewal.windows`](#obj-specrenewalwindows)
      * [`fn withCron(cron)`](#fn-specrenewalwindowswithcron)
      * [`fn withTimezone(timezone)`](#fn-specrenewalwindowswithtimezone)
      * [`fn withWindowDuration(windowDuration)`](#fn-specrenewalwindowswithwindowduration)
...
### fn spec.withRenewBeforePercentage

```ts
withRenewBeforePercentage(renewBeforePercentage)
```
...
### fn spec.withSignatureAlgorithm
...
### fn spec.keystores.jks.withPassword
...
### fn spec.keystores.pkcs12.withPassword
...
### fn spec.renewal.withWindowsMixin
...
## obj spec.renewal.windows

"`windows` mentions the behavior of when the renewal must happen."

### fn spec.renewal.windows.withCron
...
### fn spec.renewal.windows.withTimezone
...
### fn spec.renewal.windows.withWindowDuration
