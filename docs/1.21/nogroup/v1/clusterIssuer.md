---
permalink: /1.21/nogroup/v1/clusterIssuer/
---
...
* [`obj spec`](#obj-spec)
  * [`obj spec.acme`](#obj-specacme)
    ...
    * [`fn withProfile(profile)`](#fn-specacmewithprofile)
    ...
    * [`obj spec.acme.solvers`](#obj-specacmesolvers)
      * [`fn withWaitInsteadOfSelfCheck(waitInsteadOfSelfCheck)`](#fn-specacmesolverswithwaitinsteadofselfcheck)
      * [`obj spec.acme.solvers.dns01`](#obj-specacmesolversdns01)
        ...
        * [`obj spec.acme.solvers.dns01.azureDNS`](#obj-specacmesolversdns01azuredns)
          ...
          * [`fn withZoneType(zoneType)`](#fn-specacmesolversdns01azurednswithzonetype)
          ...
          * [`obj spec.acme.solvers.dns01.azureDNS.managedIdentity`](#obj-specacmesolversdns01azurednsmanagedidentity)
            ...
            * [`fn withTenantID(tenantID)`](#fn-specacmesolversdns01azurednsmanagedidentitywithtenantid)
        ...
        * [`obj spec.acme.solvers.dns01.rfc2136`](#obj-specacmesolversdns01rfc2136)
          ...
          * [`fn withProtocol(protocol)`](#fn-specacmesolversdns01rfc2136withprotocol)
      ...
      * [`obj spec.acme.solvers.http01`](#obj-specacmesolvershttp01)
        * [`obj spec.acme.solvers.http01.gatewayHTTPRoute`](#obj-specacmesolvershttp01gatewayhttproute)
          ...
          * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate`](#obj-specacmesolvershttp01gatewayhttproutepodtemplate)
            * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.metadata`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatemetadata)
              * [`fn withAnnotations(annotations)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatemetadatawithannotations)
              * [`fn withAnnotationsMixin(annotations)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatemetadatawithannotationsmixin)
              * [`fn withLabels(labels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatemetadatawithlabels)
              * [`fn withLabelsMixin(labels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatemetadatawithlabelsmixin)
            * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespec)
              * [`fn withImagePullSecrets(imagePullSecrets)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithimagepullsecrets)
              * [`fn withImagePullSecretsMixin(imagePullSecrets)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithimagepullsecretsmixin)
              * [`fn withNodeSelector(nodeSelector)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithnodeselector)
              * [`fn withNodeSelectorMixin(nodeSelector)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithnodeselectormixin)
              * [`fn withPriorityClassName(priorityClassName)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithpriorityclassname)
              * [`fn withServiceAccountName(serviceAccountName)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithserviceaccountname)
              * [`fn withTolerations(tolerations)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithtolerations)
              * [`fn withTolerationsMixin(tolerations)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecwithtolerationsmixin)
              * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinity)
                * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinity)
                  * [`fn withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitywithpreferredduringschedulingignoredduringexecution)
                  * [`fn withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitywithpreferredduringschedulingignoredduringexecutionmixin)
                  * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecution)
                    * [`fn withWeight(weight)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionwithweight)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreference)
                      * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencewithmatchexpressions)
                      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencewithmatchexpressionsmixin)
                      * [`fn withMatchFields(matchFields)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencewithmatchfields)
                      * [`fn withMatchFieldsMixin(matchFields)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencewithmatchfieldsmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchexpressions)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchexpressionswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchexpressionswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchexpressionswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchexpressionswithvaluesmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchFields`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchfields)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchfieldswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchfieldswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchfieldswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinitypreferredduringschedulingignoredduringexecutionpreferencematchfieldswithvaluesmixin)
                  * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecution)
                    * [`fn withNodeSelectorTerms(nodeSelectorTerms)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionwithnodeselectorterms)
                    * [`fn withNodeSelectorTermsMixin(nodeSelectorTerms)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionwithnodeselectortermsmixin)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectorterms)
                      * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermswithmatchexpressions)
                      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermswithmatchexpressionsmixin)
                      * [`fn withMatchFields(matchFields)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermswithmatchfields)
                      * [`fn withMatchFieldsMixin(matchFields)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermswithmatchfieldsmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchexpressions)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchexpressionswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchexpressionswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchexpressionswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchexpressionswithvaluesmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchFields`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchfields)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchfieldswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchfieldswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchfieldswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitynodeaffinityrequiredduringschedulingignoredduringexecutionnodeselectortermsmatchfieldswithvaluesmixin)
                * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinity)
                  * [`fn withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitywithpreferredduringschedulingignoredduringexecution)
                  * [`fn withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitywithpreferredduringschedulingignoredduringexecutionmixin)
                  * [`fn withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitywithrequiredduringschedulingignoredduringexecution)
                  * [`fn withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitywithrequiredduringschedulingignoredduringexecutionmixin)
                  * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecution)
                    * [`fn withWeight(weight)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionwithweight)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinityterm)
                      * [`fn withMatchLabelKeys(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmatchlabelkeys)
                      * [`fn withMatchLabelKeysMixin(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmatchlabelkeysmixin)
                      * [`fn withMismatchLabelKeys(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmismatchlabelkeys)
                      * [`fn withMismatchLabelKeysMixin(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmismatchlabelkeysmixin)
                      * [`fn withNamespaces(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithnamespaces)
                      * [`fn withNamespacesMixin(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithnamespacesmixin)
                      * [`fn withTopologyKey(topologyKey)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithtopologykey)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselector)
                        * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchexpressions)
                        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchexpressionsmixin)
                        * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchlabels)
                        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchlabelsmixin)
                        * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressions)
                          * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithkey)
                          * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithoperator)
                          * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithvalues)
                          * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithvaluesmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselector)
                        * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchexpressions)
                        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchexpressionsmixin)
                        * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchlabels)
                        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchlabelsmixin)
                        * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressions)
                          * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithkey)
                          * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithoperator)
                          * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithvalues)
                          * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithvaluesmixin)
                  * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecution)
                    * [`fn withMatchLabelKeys(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionwithmatchlabelkeys)
                    * [`fn withMatchLabelKeysMixin(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionwithmatchlabelkeysmixin)
                    * [`fn withMismatchLabelKeys(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionwithmismatchlabelkeys)
                    * [`fn withMismatchLabelKeysMixin(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionwithmismatchlabelkeysmixin)
                    * [`fn withNamespaces(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionwithnamespaces)
                    * [`fn withNamespacesMixin(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionwithnamespacesmixin)
                    * [`fn withTopologyKey(topologyKey)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionwithtopologykey)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselector)
                      * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchexpressions)
                      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchexpressionsmixin)
                      * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchlabels)
                      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchlabelsmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressions)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithvaluesmixin)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselector)
                      * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchexpressions)
                      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchexpressionsmixin)
                      * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchlabels)
                      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchlabelsmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressions)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithvaluesmixin)
                * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinity)
                  * [`fn withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitywithpreferredduringschedulingignoredduringexecution)
                  * [`fn withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitywithpreferredduringschedulingignoredduringexecutionmixin)
                  * [`fn withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitywithrequiredduringschedulingignoredduringexecution)
                  * [`fn withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitywithrequiredduringschedulingignoredduringexecutionmixin)
                  * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecution)
                    * [`fn withWeight(weight)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionwithweight)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinityterm)
                      * [`fn withMatchLabelKeys(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmatchlabelkeys)
                      * [`fn withMatchLabelKeysMixin(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmatchlabelkeysmixin)
                      * [`fn withMismatchLabelKeys(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmismatchlabelkeys)
                      * [`fn withMismatchLabelKeysMixin(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithmismatchlabelkeysmixin)
                      * [`fn withNamespaces(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithnamespaces)
                      * [`fn withNamespacesMixin(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithnamespacesmixin)
                      * [`fn withTopologyKey(topologyKey)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermwithtopologykey)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselector)
                        * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchexpressions)
                        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchexpressionsmixin)
                        * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchlabels)
                        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectorwithmatchlabelsmixin)
                        * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressions)
                          * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithkey)
                          * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithoperator)
                          * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithvalues)
                          * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermlabelselectormatchexpressionswithvaluesmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselector)
                        * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchexpressions)
                        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchexpressionsmixin)
                        * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchlabels)
                        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectorwithmatchlabelsmixin)
                        * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressions)
                          * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithkey)
                          * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithoperator)
                          * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithvalues)
                          * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinitypreferredduringschedulingignoredduringexecutionpodaffinitytermnamespaceselectormatchexpressionswithvaluesmixin)
                  * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecution)
                    * [`fn withMatchLabelKeys(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionwithmatchlabelkeys)
                    * [`fn withMatchLabelKeysMixin(matchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionwithmatchlabelkeysmixin)
                    * [`fn withMismatchLabelKeys(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionwithmismatchlabelkeys)
                    * [`fn withMismatchLabelKeysMixin(mismatchLabelKeys)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionwithmismatchlabelkeysmixin)
                    * [`fn withNamespaces(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionwithnamespaces)
                    * [`fn withNamespacesMixin(namespaces)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionwithnamespacesmixin)
                    * [`fn withTopologyKey(topologyKey)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionwithtopologykey)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselector)
                      * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchexpressions)
                      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchexpressionsmixin)
                      * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchlabels)
                      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectorwithmatchlabelsmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressions)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionlabelselectormatchexpressionswithvaluesmixin)
                    * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselector)
                      * [`fn withMatchExpressions(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchexpressions)
                      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchexpressionsmixin)
                      * [`fn withMatchLabels(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchlabels)
                      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectorwithmatchlabelsmixin)
                      * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressions)
                        * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithkey)
                        * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithoperator)
                        * [`fn withValues(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithvalues)
                        * [`fn withValuesMixin(values)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecaffinitypodantiaffinityrequiredduringschedulingignoredduringexecutionnamespaceselectormatchexpressionswithvaluesmixin)
              * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.imagePullSecrets`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecimagepullsecrets)
                * [`fn withName(name)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecimagepullsecretswithname)
              * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.resources`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecresources)
                * [`fn withLimits(limits)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecresourceswithlimits)
                * [`fn withLimitsMixin(limits)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecresourceswithlimitsmixin)
                * [`fn withRequests(requests)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecresourceswithrequests)
                * [`fn withRequestsMixin(requests)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecresourceswithrequestsmixin)
              * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontext)
                * [`fn withFsGroup(fsGroup)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithfsgroup)
                * [`fn withFsGroupChangePolicy(fsGroupChangePolicy)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithfsgroupchangepolicy)
                * [`fn withRunAsGroup(runAsGroup)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithrunasgroup)
                * [`fn withRunAsNonRoot(runAsNonRoot)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithrunasnonroot)
                * [`fn withRunAsUser(runAsUser)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithrunasuser)
                * [`fn withSupplementalGroups(supplementalGroups)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithsupplementalgroups)
                * [`fn withSupplementalGroupsMixin(supplementalGroups)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithsupplementalgroupsmixin)
                * [`fn withSysctls(sysctls)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithsysctls)
                * [`fn withSysctlsMixin(sysctls)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextwithsysctlsmixin)
                * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seLinuxOptions`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextselinuxoptions)
                  * [`fn withLevel(level)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextselinuxoptionswithlevel)
                  * [`fn withRole(role)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextselinuxoptionswithrole)
                  * [`fn withType(type)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextselinuxoptionswithtype)
                  * [`fn withUser(user)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextselinuxoptionswithuser)
                * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seccompProfile`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextseccompprofile)
                  * [`fn withLocalhostProfile(localhostProfile)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextseccompprofilewithlocalhostprofile)
                  * [`fn withType(type)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextseccompprofilewithtype)
                * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.sysctls`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextsysctls)
                  * [`fn withName(name)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextsysctlswithname)
                  * [`fn withValue(value)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespecsecuritycontextsysctlswithvalue)
              * [`obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.tolerations`](#obj-specacmesolvershttp01gatewayhttproutepodtemplatespectolerations)
                * [`fn withEffect(effect)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespectolerationswitheffect)
                * [`fn withKey(key)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespectolerationswithkey)
                * [`fn withOperator(operator)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespectolerationswithoperator)
                * [`fn withTolerationSeconds(tolerationSeconds)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespectolerationswithtolerationseconds)
                * [`fn withValue(value)`](#fn-specacmesolvershttp01gatewayhttproutepodtemplatespectolerationswithvalue)
        * [`obj spec.acme.solvers.http01.ingress`](#obj-specacmesolvershttp01ingress)
          ...
          * [`obj spec.acme.solvers.http01.ingress.podTemplate`](#obj-specacmesolvershttp01ingresspodtemplate)
            ...
            * [`obj spec.acme.solvers.http01.ingress.podTemplate.spec`](#obj-specacmesolvershttp01ingresspodtemplatespec)
              ...
              * [`obj spec.acme.solvers.http01.ingress.podTemplate.spec.resources`](#obj-specacmesolvershttp01ingresspodtemplatespecresources)
                * [`fn withLimits(limits)`](#fn-specacmesolvershttp01ingresspodtemplatespecresourceswithlimits)
                * [`fn withLimitsMixin(limits)`](#fn-specacmesolvershttp01ingresspodtemplatespecresourceswithlimitsmixin)
                * [`fn withRequests(requests)`](#fn-specacmesolvershttp01ingresspodtemplatespecresourceswithrequests)
                * [`fn withRequestsMixin(requests)`](#fn-specacmesolvershttp01ingresspodtemplatespecresourceswithrequestsmixin)
              * [`obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext`](#obj-specacmesolvershttp01ingresspodtemplatespecsecuritycontext)
                * [`fn withFsGroup(fsGroup)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithfsgroup)
                * [`fn withFsGroupChangePolicy(fsGroupChangePolicy)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithfsgroupchangepolicy)
                * [`fn withRunAsGroup(runAsGroup)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithrunasgroup)
                * [`fn withRunAsNonRoot(runAsNonRoot)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithrunasnonroot)
                * [`fn withRunAsUser(runAsUser)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithrunasuser)
                * [`fn withSupplementalGroups(supplementalGroups)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithsupplementalgroups)
                * [`fn withSupplementalGroupsMixin(supplementalGroups)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithsupplementalgroupsmixin)
                * [`fn withSysctls(sysctls)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithsysctls)
                * [`fn withSysctlsMixin(sysctls)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextwithsysctlsmixin)
                * [`obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seLinuxOptions`](#obj-specacmesolvershttp01ingresspodtemplatespecsecuritycontextselinuxoptions)
                  * [`fn withLevel(level)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextselinuxoptionswithlevel)
                  * [`fn withRole(role)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextselinuxoptionswithrole)
                  * [`fn withType(type)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextselinuxoptionswithtype)
                  * [`fn withUser(user)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextselinuxoptionswithuser)
                * [`obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seccompProfile`](#obj-specacmesolvershttp01ingresspodtemplatespecsecuritycontextseccompprofile)
                  * [`fn withLocalhostProfile(localhostProfile)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextseccompprofilewithlocalhostprofile)
                  * [`fn withType(type)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextseccompprofilewithtype)
                * [`obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.sysctls`](#obj-specacmesolvershttp01ingresspodtemplatespecsecuritycontextsysctls)
                  * [`fn withName(name)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextsysctlswithname)
                  * [`fn withValue(value)`](#fn-specacmesolvershttp01ingresspodtemplatespecsecuritycontextsysctlswithvalue)
  ...
  * [`obj spec.vault`](#obj-specvault)
    ...
    * [`fn withServerName(serverName)`](#fn-specvaultwithservername)
    * [`obj spec.vault.auth`](#obj-specvaultauth)
      ...
      * [`obj spec.vault.auth.aws`](#obj-specvaultauthaws)
        * [`fn withIamRoleArn(iamRoleArn)`](#fn-specvaultauthawswithiamrolearn)
        * [`fn withMountPath(mountPath)`](#fn-specvaultauthawswithmountpath)
        * [`fn withRegion(region)`](#fn-specvaultauthawswithregion)
        * [`fn withRole(role)`](#fn-specvaultauthawswithrole)
        * [`fn withVaultHeaderValue(vaultHeaderValue)`](#fn-specvaultauthawswithvaultheadervalue)
        * [`obj spec.vault.auth.aws.serviceAccountRef`](#obj-specvaultauthawsserviceaccountref)
          * [`fn withAudiences(audiences)`](#fn-specvaultauthawsserviceaccountrefwithaudiences)
          * [`fn withAudiencesMixin(audiences)`](#fn-specvaultauthawsserviceaccountrefwithaudiencesmixin)
          * [`fn withName(name)`](#fn-specvaultauthawsserviceaccountrefwithname)
      * [`obj spec.vault.auth.clientCertificate`](#obj-specvaultauthclientcertificate)
        * [`fn withMountPath(mountPath)`](#fn-specvaultauthclientcertificatewithmountpath)
        * [`fn withName(name)`](#fn-specvaultauthclientcertificatewithname)
        * [`fn withSecretName(secretName)`](#fn-specvaultauthclientcertificatewithsecretname)
  ...
  * [`obj spec.venafi`](#obj-specvenafi)
    ...
    * [`obj spec.venafi.ngts`](#obj-specvenafingts)
      * [`fn withTokenEndpoint(tokenEndpoint)`](#fn-specvenafingtswithtokenendpoint)
      * [`fn withTsgID(tsgID)`](#fn-specvenafingtswithtsgid)
      * [`fn withUrl(url)`](#fn-specvenafingtswithurl)
      * [`obj spec.venafi.ngts.credentialsRef`](#obj-specvenafingtscredentialsref)
        * [`fn withName(name)`](#fn-specvenafingtscredentialsrefwithname)
    * [`obj spec.venafi.tpp`](#obj-specvenafitpp)
      ...
      * [`obj spec.venafi.tpp.caBundleSecretRef`](#obj-specvenafitppcabundlesecretref)
        * [`fn withKey(key)`](#fn-specvenafitppcabundlesecretrefwithkey)
        * [`fn withName(name)`](#fn-specvenafitppcabundlesecretrefwithname)
...
### fn spec.acme.solvers.withWaitInsteadOfSelfCheck

```ts
withWaitInsteadOfSelfCheck(waitInsteadOfSelfCheck)
```
...
### fn spec.acme.solvers.dns01.azureDNS.withZoneType
...
### fn spec.acme.solvers.dns01.azureDNS.managedIdentity.withTenantID
...
### fn spec.acme.solvers.dns01.rfc2136.withProtocol
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.metadata

"ObjectMeta overrides for the pod used to solve HTTP01 challenges.\nOnly the 'labels' and 'annotations' fields may be set.\nIf labels or annotations overlap with in-built values, the values here\nwill override the in-built values."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.metadata.withAnnotations
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.metadata.withAnnotationsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.metadata.withLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.metadata.withLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec

"PodSpec defines overrides for the HTTP01 challenge solver pod.\nCheck ACMEChallengeSolverHTTP01IngressPodSpec to find out currently supported fields.\nAll other fields will be ignored."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withImagePullSecrets
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withImagePullSecretsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withNodeSelector
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withNodeSelectorMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withPriorityClassName
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withServiceAccountName
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withTolerations
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.withTolerationsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity

"If specified, the pod's scheduling constraints"

## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity

"Describes node affinity scheduling rules for the pod."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.withPreferredDuringSchedulingIgnoredDuringExecution
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.withPreferredDuringSchedulingIgnoredDuringExecutionMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution

"The scheduler will prefer to schedule pods to nodes that satisfy\nthe affinity expressions specified by this field, but it may choose\na node that violates one or more of the expressions. The node that is\nmost preferred is the one with the greatest sum of weights, i.e.\nfor each node that meets all of the scheduling requirements (resource\nrequest, requiredDuringScheduling affinity expressions, etc.),\ncompute a sum by iterating through the elements of this field and adding\n\"weight\" to the sum if the node matches the corresponding matchExpressions; the\nnode(s) with the highest sum are the most preferred."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.withWeight
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference

"A node selector term, associated with the corresponding weight."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.withMatchFields
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.withMatchFieldsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchExpressions

"A list of node selector requirements by node's labels."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchFields

"A list of node selector requirements by node's fields."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchFields.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchFields.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchFields.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution.preference.matchFields.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution

"If the affinity requirements specified by this field are not met at\nscheduling time, the pod will not be scheduled onto the node.\nIf the affinity requirements specified by this field cease to be met\nat some point during pod execution (e.g. due to an update), the system\nmay or may not try to eventually evict the pod from its node."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.withNodeSelectorTerms
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.withNodeSelectorTermsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms

"Required. A list of node selector terms. The terms are ORed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.withMatchFields
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.withMatchFieldsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchExpressions

"A list of node selector requirements by node's labels."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchFields

"A list of node selector requirements by node's fields."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchFields.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchFields.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchFields.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms.matchFields.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity

"Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s))."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.withPreferredDuringSchedulingIgnoredDuringExecution
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.withPreferredDuringSchedulingIgnoredDuringExecutionMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.withRequiredDuringSchedulingIgnoredDuringExecution
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.withRequiredDuringSchedulingIgnoredDuringExecutionMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution

"The scheduler will prefer to schedule pods to nodes that satisfy\nthe affinity expressions specified by this field, but it may choose\na node that violates one or more of the expressions. The node that is\nmost preferred is the one with the greatest sum of weights, i.e.\nfor each node that meets all of the scheduling requirements (resource\nrequest, requiredDuringScheduling affinity expressions, etc.),\ncompute a sum by iterating through the elements of this field and adding\n\"weight\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\nnode(s) with the highest sum are the most preferred."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.withWeight
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm

"Required. A pod affinity term, associated with the corresponding weight."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMismatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMismatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withNamespaces
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withNamespacesMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withTopologyKey
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector

"A label query over a set of resources, in this case pods.\nIf it's null, this PodAffinityTerm matches with no Pods."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector

"A label query over the set of namespaces that the term applies to.\nThe term is applied to the union of the namespaces selected by this field\nand the ones listed in the namespaces field.\nnull selector and null or empty namespaces list means \"this pod's namespace\".\nAn empty selector ({}) matches all namespaces."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution

"If the affinity requirements specified by this field are not met at\nscheduling time, the pod will not be scheduled onto the node.\nIf the affinity requirements specified by this field cease to be met\nat some point during pod execution (e.g. due to a pod label update), the\nsystem may or may not try to eventually evict the pod from its node.\nWhen there are multiple elements, the lists of nodes corresponding to each\npodAffinityTerm are intersected, i.e. all terms must be satisfied."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMismatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMismatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.withNamespaces
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.withNamespacesMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.withTopologyKey
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector

"A label query over a set of resources, in this case pods.\nIf it's null, this PodAffinityTerm matches with no Pods."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector

"A label query over the set of namespaces that the term applies to.\nThe term is applied to the union of the namespaces selected by this field\nand the ones listed in the namespaces field.\nnull selector and null or empty namespaces list means \"this pod's namespace\".\nAn empty selector ({}) matches all namespaces."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity

"Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s))."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.withPreferredDuringSchedulingIgnoredDuringExecution
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.withPreferredDuringSchedulingIgnoredDuringExecutionMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.withRequiredDuringSchedulingIgnoredDuringExecution
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.withRequiredDuringSchedulingIgnoredDuringExecutionMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution

"The scheduler will prefer to schedule pods to nodes that satisfy\nthe anti-affinity expressions specified by this field, but it may choose\na node that violates one or more of the expressions. The node that is\nmost preferred is the one with the greatest sum of weights, i.e.\nfor each node that meets all of the scheduling requirements (resource\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\ncompute a sum by iterating through the elements of this field and subtracting\n\"weight\" from the sum if the node has pods which matches the corresponding podAffinityTerm; the\nnode(s) with the highest sum are the most preferred."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.withWeight
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm

"Required. A pod affinity term, associated with the corresponding weight."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMismatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withMismatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withNamespaces
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withNamespacesMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.withTopologyKey
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector

"A label query over a set of resources, in this case pods.\nIf it's null, this PodAffinityTerm matches with no Pods."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.labelSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector

"A label query over the set of namespaces that the term applies to.\nThe term is applied to the union of the namespaces selected by this field\nand the ones listed in the namespaces field.\nnull selector and null or empty namespaces list means \"this pod's namespace\".\nAn empty selector ({}) matches all namespaces."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.namespaceSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution

"If the anti-affinity requirements specified by this field are not met at\nscheduling time, the pod will not be scheduled onto the node.\nIf the anti-affinity requirements specified by this field cease to be met\nat some point during pod execution (e.g. due to a pod label update), the\nsystem may or may not try to eventually evict the pod from its node.\nWhen there are multiple elements, the lists of nodes corresponding to each\npodAffinityTerm are intersected, i.e. all terms must be satisfied."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMismatchLabelKeys
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.withMismatchLabelKeysMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.withNamespaces
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.withNamespacesMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.withTopologyKey
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector

"A label query over a set of resources, in this case pods.\nIf it's null, this PodAffinityTerm matches with no Pods."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.labelSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector

"A label query over the set of namespaces that the term applies to.\nThe term is applied to the union of the namespaces selected by this field\nand the ones listed in the namespaces field.\nnull selector and null or empty namespaces list means \"this pod's namespace\".\nAn empty selector ({}) matches all namespaces."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchExpressions
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchExpressionsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchLabels
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.withMatchLabelsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withValues
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.affinity.podAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution.namespaceSelector.matchExpressions.withValuesMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.imagePullSecrets

"If specified, the pod's imagePullSecrets"

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.imagePullSecrets.withName
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.resources
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.resources.withLimits
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.resources.withLimitsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.resources.withRequests
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.resources.withRequestsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext

"If specified, the pod's security context"

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withFsGroup
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withFsGroupChangePolicy
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withRunAsGroup
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withRunAsNonRoot
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withRunAsUser
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withSupplementalGroups
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withSupplementalGroupsMixin
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withSysctls
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.withSysctlsMixin
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seLinuxOptions

"The SELinux context to be applied to all containers.\nIf unspecified, the container runtime will allocate a random SELinux context for each\ncontainer.  May also be set in SecurityContext.  If set in\nboth SecurityContext and PodSecurityContext, the value specified in SecurityContext\ntakes precedence for that container.\nNote that this field cannot be set when spec.os.name is windows."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seLinuxOptions.withLevel
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seLinuxOptions.withRole
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seLinuxOptions.withType
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seLinuxOptions.withUser
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seccompProfile

"The seccomp options to use by the containers in this pod.\nNote that this field cannot be set when spec.os.name is windows."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seccompProfile.withLocalhostProfile
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.seccompProfile.withType
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.sysctls

"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\nsysctls (by the container runtime) might fail to launch.\nNote that this field cannot be set when spec.os.name is windows."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.sysctls.withName
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.securityContext.sysctls.withValue
...
## obj spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.tolerations

"If specified, the pod's tolerations."

### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.tolerations.withEffect
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.tolerations.withKey
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.tolerations.withOperator
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.tolerations.withTolerationSeconds
...
### fn spec.acme.solvers.http01.gatewayHTTPRoute.podTemplate.spec.tolerations.withValue
...
## obj spec.acme.solvers.http01.ingress.podTemplate.spec.resources

"If specified, the pod's resource requirements.\nThese values override the global resource configuration flags.\nNote that when only specifying resource limits, ensure they are greater than or equal\nto the corresponding global resource requests configured via controller flags\n(--acme-http01-solver-resource-request-cpu, --acme-http01-solver-resource-request-memory).\nKubernetes will reject pod creation if limits are lower than requests, causing challenge failures."

### fn spec.acme.solvers.http01.ingress.podTemplate.spec.resources.withLimits
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.resources.withLimitsMixin
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.resources.withRequests
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.resources.withRequestsMixin
...
## obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext

"If specified, the pod's security context"

### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withFsGroup
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withFsGroupChangePolicy
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withRunAsGroup
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withRunAsNonRoot
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withRunAsUser
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withSupplementalGroups
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withSupplementalGroupsMixin
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withSysctls
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.withSysctlsMixin
...
## obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seLinuxOptions

"The SELinux context to be applied to all containers.\nIf unspecified, the container runtime will allocate a random SELinux context for each\ncontainer.  May also be set in SecurityContext.  If set in\nboth SecurityContext and PodSecurityContext, the value specified in SecurityContext\ntakes precedence for that container.\nNote that this field cannot be set when spec.os.name is windows."

### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seLinuxOptions.withLevel
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seLinuxOptions.withRole
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seLinuxOptions.withType
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seLinuxOptions.withUser
...
## obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seccompProfile

"The seccomp options to use by the containers in this pod.\nNote that this field cannot be set when spec.os.name is windows."

### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seccompProfile.withLocalhostProfile
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.seccompProfile.withType
...
## obj spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.sysctls

"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\nsysctls (by the container runtime) might fail to launch.\nNote that this field cannot be set when spec.os.name is windows."

### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.sysctls.withName
...
### fn spec.acme.solvers.http01.ingress.podTemplate.spec.securityContext.sysctls.withValue
...
### fn spec.vault.auth.aws.withIamRoleArn
...
### fn spec.vault.auth.aws.withMountPath
...
### fn spec.vault.auth.aws.withRegion
...
### fn spec.vault.auth.aws.withRole
...
### fn spec.vault.auth.aws.withVaultHeaderValue

```ts
withVaultHeaderValue(vaultHeaderValue)
```

"The Vault header value to include in the STS signing request.\nThis is used to prevent replay attacks."

## obj spec.vault.auth.aws.serviceAccountRef
...
### fn spec.vault.auth.aws.serviceAccountRef.withAudiences
...
### fn spec.vault.auth.aws.serviceAccountRef.withAudiencesMixin
...
### fn spec.vault.auth.aws.serviceAccountRef.withName
...
## obj spec.vault.auth.clientCertificate

"ClientCertificate authenticates with Vault by presenting a client\ncertificate during the request's TLS handshake.\nWorks only when using HTTPS protocol."

### fn spec.vault.auth.clientCertificate.withMountPath
...
### fn spec.vault.auth.clientCertificate.withName
...
### fn spec.vault.auth.clientCertificate.withSecretName
...
### fn spec.venafi.ngts.withTokenEndpoint
...
## obj spec.venafi.ngts.credentialsRef
...
### fn spec.venafi.ngts.credentialsRef.withName
...
## obj spec.venafi.tpp.caBundleSecretRef
...
### fn spec.venafi.tpp.caBundleSecretRef.withKey
...
### fn spec.venafi.tpp.caBundleSecretRef.withName
