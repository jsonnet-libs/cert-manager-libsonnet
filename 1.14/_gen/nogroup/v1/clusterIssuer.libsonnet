{
  ...
  spec: {
    ...
    acme: {
      ...
      solvers: {
        ...
        dns01: {
          ...
          azureDNS: {
            '#clientSecretSecretRef':: d.obj(help='"Auth: Azure Service Principal: A reference to a Secret containing the password associated with the Service Principal. If set, ClientID and TenantID must also be set."'),
            clientSecretSecretRef: {
              '#withKey':: d.fn(help="\"The key of the entry in the Secret resource's `data` field to be used. Some instances of this field may be defaulted, in others it may be required.\"", args=[d.arg(name='key', type=d.T.string)]),
            ...
            '#managedIdentity':: d.obj(help='"Auth: Azure Workload Identity or Azure Managed Service Identity: Settings to enable Azure Workload Identity or Azure Managed Service Identity If set, ClientID, ClientSecret and TenantID must not be set."'),
            managedIdentity: {
              ...
              '#withResourceID':: d.fn(help='"resource ID of the managed identity, can not be used at the same time as clientID Cannot be used for Azure Managed Service Identity"', args=[d.arg(name='resourceID', type=d.T.string)]),
              withResourceID(resourceID): { dns01+: { azureDNS+: { managedIdentity+: { resourceID: resourceID } } } },
            },
            '#withClientID':: d.fn(help='"Auth: Azure Service Principal: The ClientID of the Azure Service Principal used to authenticate with Azure DNS. If set, ClientSecret and TenantID must also be set."', args=[d.arg(name='clientID', type=d.T.string)]),
            ...
            '#withTenantID':: d.fn(help='"Auth: Azure Service Principal: The TenantID of the Azure Service Principal used to authenticate with Azure DNS. If set, ClientID and ClientSecret must also be set."', args=[d.arg(name='tenantID', type=d.T.string)]),
          ...
          route53: {
            '#accessKeyIDSecretRef':: d.obj(help='"The SecretAccessKey is used for authentication. If set, pull the AWS access key ID from a key within a Kubernetes Secret. Cannot be set when AccessKeyID is set. If neither the Access Key nor Key ID are set, we fall-back to using env vars, shared credentials file or AWS Instance metadata, see: https://docs.aws.amazon.com/sdk-for-go/v1/developer-guide/configuring-sdk.html#specifying-credentials"'),
            accessKeyIDSecretRef: {
              '#withKey':: d.fn(help="\"The key of the entry in the Secret resource's `data` field to be used. Some instances of this field may be defaulted, in others it may be required.\"", args=[d.arg(name='key', type=d.T.string)]),
            ...
            '#secretAccessKeySecretRef':: d.obj(help='"The SecretAccessKey is used for authentication. If neither the Access Key nor Key ID are set, we fall-back to using env vars, shared credentials file or AWS Instance metadata, see: https://docs.aws.amazon.com/sdk-for-go/v1/developer-guide/configuring-sdk.html#specifying-credentials"'),
            ...
            '#withAccessKeyID':: d.fn(help='"The AccessKeyID is used for authentication. Cannot be set when SecretAccessKeyID is set. If neither the Access Key nor Key ID are set, we fall-back to using env vars, shared credentials file or AWS Instance metadata, see: https://docs.aws.amazon.com/sdk-for-go/v1/developer-guide/configuring-sdk.html#specifying-credentials"', args=[d.arg(name='accessKeyID', type=d.T.string)]),
        ...
        http01: {
          ...
          gatewayHTTPRoute: {
            '#parentRefs':: d.obj(help='"When solving an HTTP-01 challenge, cert-manager creates an HTTPRoute. cert-manager needs to know which parentRefs should be used when creating the HTTPRoute. Usually, the parentRef references a Gateway. See: https://gateway-api.sigs.k8s.io/api-types/httproute/#attaching-to-gateways"'),
            parentRefs: {
              '#withGroup':: d.fn(help='"Group is the group of the referent. When unspecified, \\"gateway.networking.k8s.io\\" is inferred. To set the core API group (such as for a \\"Service\\" kind referent), Group must be explicitly set to \\"\\" (empty string). \\n Support: Core"', args=[d.arg(name='group', type=d.T.string)]),
          ...
          ingress: {
            ...
            podTemplate: {
              ...
              '#spec':: d.obj(help='"PodSpec defines overrides for the HTTP01 challenge solver pod. Check ACMEChallengeSolverHTTP01IngressPodSpec to find out currently supported fields. All other fields will be ignored."'),
              spec: {
            ...
            '#withClass':: d.fn(help='"This field configures the annotation `kubernetes.io/ingress.class` when creating Ingress resources to solve ACME challenges that use this challenge solver. Only one of `class`, `name` or `ingressClassName` may be specified."', args=[d.arg(name='class', type=d.T.string)]),
            withClass(class): { http01+: { ingress+: { class: class } } },
            '#withIngressClassName':: d.fn(help='"This field configures the field `ingressClassName` on the created Ingress resources used to solve ACME challenges that use this challenge solver. This is the recommended way of configuring the ingress class. Only one of `class`, `name` or `ingressClassName` may be specified."', args=[d.arg(name='ingressClassName', type=d.T.string)]),
            withIngressClassName(ingressClassName): { http01+: { ingress+: { ingressClassName: ingressClassName } } },
            '#withName':: d.fn(help='"The name of the ingress resource that should have ACME challenge solving routes inserted into it in order to solve HTTP01 challenges. This is typically used in conjunction with ingress controllers like ingress-gce, which maintains a 1:1 mapping between external IPs and ingress resources. Only one of `class`, `name` or `ingressClassName` may be specified."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    ca: {
      ...
      '#withIssuingCertificateURLs':: d.fn(help='"IssuingCertificateURLs is a list of URLs which this issuer should embed into certificates it creates. See https://www.rfc-editor.org/rfc/rfc5280#section-4.2.2.1 for more details. As an example, such a URL might be \\"http://ca.domain.com/ca.crt\\"."', args=[d.arg(name='issuingCertificateURLs', type=d.T.array)]),
      ...
      '#withIssuingCertificateURLsMixin':: d.fn(help='"IssuingCertificateURLs is a list of URLs which this issuer should embed into certificates it creates. See https://www.rfc-editor.org/rfc/rfc5280#section-4.2.2.1 for more details. As an example, such a URL might be \\"http://ca.domain.com/ca.crt\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='issuingCertificateURLs', type=d.T.array)]),
